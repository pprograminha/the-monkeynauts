...
@ToString
public class MonkeynautSkillAttribute {
    ...
    public MonkeynautSkillAttribute(int value) {
        if (value < LOW_LIMIT || value > HIGH_LIMIT) {
            throw new AttributeOutOfRangeException(MonkeynautSkillAttribute.class);
        }
        this.value = value;
    }
    ...
    public boolean equals(Object o) {
        ...
        MonkeynautSkillAttribute that = (MonkeynautSkillAttribute) o;
