...
@ToString
public class MonkeynautResistanceAttribute {
    ...
    public MonkeynautResistanceAttribute(int value) {
    ...
    public boolean equals(Object o) {
        ...
        MonkeynautResistanceAttribute that = (MonkeynautResistanceAttribute) o;
